      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 pb-24 flex flex-col lg:flex-row gap-12">
        ...
        <div className="hidden lg:block w-72 flex-shrink-0">
          <div className="sticky top-28 space-y-2">
            ...
            <div className="h-4 border-l border-slate-800 ml-8 my-1" />
        ...
        <div className="flex-1 max-w-3xl space-y-20">
          ...
          <section id="setup" className="scroll-mt-28">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-slate-800 text-slate-400 font-bold text-xl">1</div>
              <h2 className="text-3xl font-bold text-white">Prerequisites</h2>
            </div>
            
            <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8 backdrop-blur-sm hover:border-slate-700 transition-colors">
              ...
              <div className="bg-blue-500/5 border border-blue-500/10 rounded-xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400 mb-3">Available for Chrome, Firefox, iOS, and Android.</p>
                    <a 
          ...
          <section id="connect" className="scroll-mt-28">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-slate-800 text-slate-400 font-bold text-xl">2</div>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={i} className="flex items-start gap-4 bg-slate-900/30 border border-slate-800/50 p-6 rounded-xl">
                  <div className="flex items-center justify-center w-8 h-8 rounded-full bg-slate-800 text-slate-400 font-bold text-sm flex-shrink-0">
                    {i + 1}
                  </div>
                  <div>
          ...
          <section id="eth" className="scroll-mt-28">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-slate-800 text-slate-400 font-bold text-xl">3</div>
            ...
            <div className="mt-8">
              <h4 className="text-sm font-bold text-slate-500 uppercase tracking-wider mb-4">Alternative External Faucets</h4>
              <div className="grid md:grid-cols-2 gap-4">
                <a href="https://sepoliafaucet.com" target="_blank" rel="noopener noreferrer" className="bg-slate-900/50 border border-slate-800 p-4 rounded-xl hover:border-slate-700 transition-all group">
                  <h5 className="font-bold text-white mb-1 group-hover:text-blue-400 transition-colors">Alchemy Faucet</h5>
                  <p className="text-xs text-slate-500">Requires free account • 0.5 ETH/day</p>
                </a>
                <a href="https://cloud.google.com/application/web3/faucet/ethereum/sepolia" target="_blank" rel="noopener noreferrer" className="bg-slate-900/50 border border-slate-800 p-4 rounded-xl hover:border-slate-700 transition-all group">
                  <h5 className="font-bold text-white mb-1 group-hover:text-blue-400 transition-colors">Google Cloud Faucet</h5>
                  <p className="text-xs text-slate-500">Requires Google account • 0.05 ETH/day</p>
                </a>
              </div>
            </div>
          </section>
          ...
          <section id="usdc" className="scroll-mt-28">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-slate-800 text-slate-400 font-bold text-xl">4</div>
            ...
            <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8 backdrop-blur-sm">
              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-6 flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="flex-shrink-0">
                  <div className="px-4 py-2 bg-slate-800 rounded text-xs font-mono text-slate-300 border border-slate-700">
          ...
          <section id="deposit" className="scroll-mt-28">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-slate-800 text-slate-400 font-bold text-xl">5</div>
          ...
          <section id="trade" className="scroll-mt-28">
            <div className="flex items-center gap-4 mb-8">
              <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-slate-800 text-slate-400 font-bold text-xl">6</div>
              ...
              <div className="flex flex-col md:flex-row gap-8">
                <div className="flex-1">
                  ...
                  <ul className="space-y-4">
                    <li className="flex gap-3">
                      <div className="w-6 h-6 rounded-full bg-slate-800 text-slate-400 flex items-center justify-center text-xs font-bold flex-shrink-0">1</div>
                      <p className="text-sm text-slate-300">Select a market (e.g., ETH-PERP)</p>
                    </li>
                    <li className="flex gap-3">
                      <div className="w-6 h-6 rounded-full bg-slate-800 text-slate-400 flex items-center justify-center text-xs font-bold flex-shrink-0">2</div>
                      <p className="text-sm text-slate-300">Choose <strong>Long</strong> (Buy) or <strong>Short</strong> (Sell)</p>
                    </li>
                    <li className="flex gap-3">
                      <div className="w-6 h-6 rounded-full bg-slate-800 text-slate-400 flex items-center justify-center text-xs font-bold flex-shrink-0">3</div>
                      <p className="text-sm text-slate-300">Enter position size and leverage</p>
                    </li>
                    <li className="flex gap-3">
                      <div className="w-6 h-6 rounded-full bg-slate-800 text-slate-400 flex items-center justify-center text-xs font-bold flex-shrink-0">4</div>
                      <p className="text-sm text-slate-300">Confirm the trade</p>
                    </li>
                  </ul>
                </div>
                ...
                <div className="w-full md:w-64 flex flex-col gap-4">
                  <div className="bg-green-500/5 border border-green-500/20 p-4 rounded-xl">
                    ...
                    <p className="text-xs text-slate-400">Profit when price goes <strong>UP</strong></p>
                  </div>
                  <div className="bg-red-500/5 border border-red-500/20 p-4 rounded-xl">
                    ...
                    <p className="text-xs text-slate-400">Profit when price goes <strong>DOWN</strong></p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="pt-12 pb-8 text-center">
            ...
            <p className="text-slate-400 mb-8">You have all the tools you need. Join the future of trading.</p>
            <Link 
              to="/trade" 
