...
const TEAM = [
  {
    ...
    bio: "Quinn leads engineering and product at ByteStrike, owning the protocol architecture and the exchange's technical roadmap. Placeholder bio — final copy to follow.",
  },
  {
    name: "Gabe Jaffe",
    role: "Founder & CEO",
    ...
    bio: "Gabe founded ByteStrike and sets the company's strategy, partnerships, and long-term direction for the compute-futures market. Placeholder bio — final copy to follow.",
  },
  {
    name: "Amit Vijay",
    ...
    bio: "Amit oversees compliance and risk, aligning the exchange's controls and risk framework with the standards expected of a regulated venue. Placeholder bio — final copy to follow.",
  },
  {
    ...
    bio: "Malcolm serves as Senior Representative and Independent Non-Executive Director, bringing independent oversight to the board. Placeholder bio — final copy to follow.",
  },
  {
    ...
    bio: "Alison is the Money Laundering Reporting Officer, responsible for AML/CFT reporting and the integrity of the exchange's financial-crime controls. Placeholder bio — final copy to follow.",
  },
  {
    ...
    bio: "Sebastian shapes ByteStrike's regulatory strategy across jurisdictions, guiding engagement with regulators as the platform scales. Placeholder bio — final copy to follow.",
  },
];
