          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {whyNowCardsData.map((card, index) => (
              <motion.div
                ...
                className="group relative rounded-3xl overflow-hidden border border-white/5 bg-slate-900/40 backdrop-blur-sm hover:bg-slate-900/60 transition-all duration-500"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                
                <div className="p-8 h-full flex flex-col relative z-10">
                  <div className="mb-auto">
                    <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center text-indigo-400 mb-6 group-hover:scale-110 group-hover:bg-indigo-500/20 transition-all duration-300">
                      {card.icon}
                    </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative group">
              <div className="absolute inset-0 bg-indigo-600 blur-[50px] opacity-20 group-hover:opacity-40 transition-opacity duration-500 rounded-full"></div>
              <img
                src={ceoPortrait}
                alt="Gabe Jaffe"
                loading="lazy"
